...
for i, var in enumerate(variables):
    ...
    ds = xr.open_dataset(
        f'{data_dir}/{case_name}/lnd/proc/tseries/{freq}/{case_name}.clm2.{hist_type}.{var}.185001-201412.nc',
        decode_times=True,
    )
    ...
    # Save as NetCDF file
    print(f'/glade/work/bbuchovecky/WUE_analysis/{case_name}.clm2.{hist_type}.{var}.185001-201412_gridded.nc')
    dense_da.to_netcdf(f'/glade/work/bbuchovecky/WUE_analysis/{case_name}.clm2.{hist_type}.{var}.185001-201412_gridded.nc')