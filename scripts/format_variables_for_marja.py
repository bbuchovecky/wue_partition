...
def select_sites_from_gridded_data(xr_grid_data, df_site_data):
    ...
    for i, row in df_site_data.iterrows():
        if i % 50 == 0:
            print(f'\tprocessing site {i+1} of {nsite}')
...
for var in variables:
    ...
    print(f'done selecting sites for {var}')
    ...
    for pft in sitepft:
        ...
        print(f'done saving {var} pft{pft}')
    ...
    print(f'done saving {var} pftall')
